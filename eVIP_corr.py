...
def main():
    ...
    # print(options.input)
    # print(options.z_output)
    # print(options.sp_output)
...
def api_main(input=None,z_output=None,sp_output=None):
    # print('new main')
    if input == None:
        raise Exception("Missing input file in function call")
    if z_output == None:
        raise Exception("Missing z_output in function call")
    if sp_output == None:
        raise Exception("Missing sp_output file in function call")

    # Pulling parameters from function def instead of options (cli)
    # print(input)
    # print(z_output)
    # print(sp_output)
    input_file = open(str(input), "r")
    z_output= open(str(z_output)+".txt", "w+")
    sp_output = open(str(sp_output)+".gct", "w")
    ...
    data = np.loadtxt(strip_first_col(input), skiprows=1)
